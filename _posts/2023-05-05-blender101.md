...
![](/assets/img/blender%20tutorialto%20export_html_2bfcc0a2d54bb959.png)

![](/assets/img/blender%20tutorialto%20export_html_a99afa06c61a2d65.png)
...
![](/assets/img/blender%20tutorialto%20export_html_8302cd35154d18b9.png)
...
Press “tab” to change from object mode to **Edit mode** ![](/assets/img/blender%20tutorialto%20export_html_9f55ba24a2742e4b.png)

you can press “A” to select all the mode´s **vectors**/**edges**/**faces**

depending of the: ![](/assets/img/blender%20tutorialto%20export_html_65366b36d99143b4.png)
...
![](/assets/img/blender%20tutorialto%20export_html_75e2db3d1e97b4c8.png)
...
![](/assets/img/blender%20tutorialto%20export_html_7605416ad5a244dd.png)
...
![](/assets/img/blender%20tutorialto%20export_html_a26b08d924df3518.png)

do the “soda can” method: 

![](/assets/img/blender%20tutorialto%20export_html_fd6b8fbb10a46ba6.png)
...
![](/assets/img/blender%20tutorialto%20export_html_be9978d8d915b8ba.png)


in edit mode select your mesh, go to option and select **live unwrap**


![](/assets/img/blender%20tutorialto%20export_html_f09f28809c5b402c.png)
...
![](/assets/img/blender%20tutorialto%20export_html_3426d6eb3332c84f.png)
...
![](/assets/img/blender%20tutorialto%20export_html_a5ef995aaeb6ebe2.png)

2\_ try to make textures with this parameters in mind

alt + f rotates the object

![](/assets/img/blender%20tutorialto%20export_html_ba9c6da0a1e340c4.png)

alt + f rotates the object 

for the materials, u can use the closest texture interpolation:

![](/assets/img/blender101_html_585e91cfc35e1bbf.png)
...
![](/assets/img/blender%20tutorialto%20export_html_e5ca5d468d6e9424.png)

once in

![](/assets/img/blender%20tutorialto%20export_html_1c997ea546caf6fb.png)

mode go to the **shading options** (top right) and select flat shading to see the pure colors

![](/assets/img/blender%20tutorialto%20export_html_cd787f3109d54c8d.png)
...
![](/assets/img/blender%20tutorialto%20export_html_2bdcd5e4a01049d3.png)

  

still in active tool go to **falloff** and disable it so u can draw near the edges

![](/assets/img/blender%20tutorialto%20export_html_cd3a35094b548a57.png)
...
![](/assets/img/blender%20tutorialto%20export_html_8573d706322e5c48.png)
...
![](/assets/img/blender%20tutorialto%20export_html_2f29513cbbfcc561.png) 
...
![](/assets/img/blender%20tutorialto%20export_html_2f0cb3959c1ba54c.png)
...
![](/assets/img/blender%20tutorialto%20export_html_10a3893c0b3c7ff2.png)

>its good practice to change the display as types of bones for different rigs		
![](/assets/img/blender101_html_b41ec2b154f1d71d.png)
...
![](/assets/img/blender%20tutorialto%20export_html_6de8402f630073.png)


> (REMEMBER!!!!!!!!!
The last selected bone ll hallway be the root of the offset, if u select more than the 2 bones (“shift” + “click”) the last one been selected ll be the parent): ![](/assets/img/blender%20tutorialto%20export_html_3da50fd1b5682abc.png)

  

once u r done select all bones(“A”) in edit mode and **symmetrize**

![](/assets/img/blender%20tutorialto%20export_html_fd574e1472a422c0.png)
...
![](/assets/img/blender%20tutorialto%20export_html_9d9988083a6963a1.png)

  

![](/assets/img/blender%20tutorialto%20export_html_7bb6c3757f814a3d.png)
...
![](/assets/img/blender%20tutorialto%20export_html_d66724af215171b1.png)
...
![](/assets/img/blender%20tutorialto%20export_html_8e746d35acbbd7b5.png)
...
![](/assets/img/blender%20tutorialto%20export_html_4bf0a37411906f70.png)
...
![](/assets/img/blender%20tutorialto%20export_html_9a3768560912cc20.png)
...
![](/assets/img/blender%20tutorialto%20export_html_3a639eedb56da080.png)

> don't be scared if its looks like so 

![](/assets/img/blender%20tutorialto%20export_html_ee8417ac62de4fd3.png)
...
![](/assets/img/blender%20tutorialto%20export_html_ef567706d5ad12a3.png)
...
![](/assets/img/blender%20tutorialto%20export_html_c8605270f55079db.png)
...
![](/assets/img/blender%20tutorialto%20export_html_2a485220ff6008b9.png)
...
![](/assets/img/blender%20tutorialto%20export_html_af91c4e3c88ce3e.png)
...
![](/assets/img/blender%20tutorialto%20export_html_724dfa81fef68df4.png)
...
![](/assets/img/blender%20tutorialto%20export_html_2f8cec7d8e54d1bc.png)


name it (in this case “pole.L”) set the target like so:

![](/assets/img/blender%20tutorialto%20export_html_5ba7a58081b0b269.png)
...
![](/assets/img/blender%20tutorialto%20export_html_fbbaa5b6f4124965.png)
...
select the foot press “alt” + “p” in edit mode and clear its parents then select the shin bone(the one in yellow in the picture) and shift select the foot, “cnt” + “shift” + “c” for the **copy location** transform, the foot is going to go for the shin location, to make it respect the bones like before go to bone constraints properties, **head/tail** value to 1
 ...
 ![](/assets/img/blender%20tutorialto%20export_html_21a59fd2385014d9.png) ![](/assets/img/4.png)
...
![](/assets/img/blender101_html_d41991e0c0724295.png)
...
![](/assets/img/blender101_html_9e52bddbe21877d3.png)
...
![](/assets/img/blender101_html_1edb8f2731bb8d7a.png)
...
![](/assets/img/blender%20tutorialto%20export_html_ae245c44245b7178.png)
...
then create a new action and set its fake user so u don’t lose your animations in the NLA editor or something else goes wrong
 ...
 ![](/assets/img/blender%20tutorialto%20export_html_d300a05b7aafbdd1.png) ![](/assets/img/blender%20tutorialto%20export_html_c5398c5f7e78f48a.png)
...
![](/assets/img/blender%20tutorialto%20export_html_965f2a489e5123b6.png)
...
selecting an animation in the dope sheet editor type making sure it plays correctly, then changing the editor type to **nonlinear animation** and organizing them one by one like so: ![](/assets/img/blender%20tutorialto%20export_html_3e36522a4e293a64.png)
...
![](/assets/img/blender%20tutorialto%20export_html_5b874cb92492ef8a.png)
...
![](/assets/img/blender%20tutorialto%20export_html_3031f9b19e58efad.png)
...
![](/assets/img/blender%20tutorialto%20export_html_adc2aa5c9f3168d3.png)
...
![](/assets/img/blender101_html_c698b2c487d6a022.png)
...
![](/assets/img/blender101_html_b35c92fd2ca15c78.png)
...
![](/assets/img/blender101_html_5c9377384b9350db.png)

once u create the texture open the **UV Editing workspace**, in the UV menu, select **Export UV Layout**

![](/assets/img/blender101_html_3dfdc78835260b36.png)
...
![](/assets/img/blender101_html_aff7eeee53be9d59.png)
...
![](/assets/img/blender101_html_29cf4e26146edf7c.png)
